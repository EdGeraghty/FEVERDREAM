...
import java.lang.ref.Cleaner as JavaLangRefCleaner
...
// Type aliases for RustBuffer types
typealias RustBufferCollectStrategy = uniffi.matrix_sdk_crypto.RustBuffer.ByValue
typealias RustBufferDecryptionSettings = uniffi.matrix_sdk_crypto.RustBuffer.ByValue
typealias RustBufferLocalTrust = uniffi.matrix_sdk_crypto.RustBuffer.ByValue
typealias RustBufferSignatureState = uniffi.matrix_sdk_crypto.RustBuffer.ByValue
...
internal interface UniffiLib : Library {
    ...
    fun uniffi_matrix_sdk_crypto_ffi_fn_method_olmmachine_create_encrypted_to_device_request(`ptr`: Pointer,`userId`: RustBuffer.ByValue,`deviceId`: RustBuffer.ByValue,`eventType`: RustBuffer.ByValue,`content`: RustBuffer.ByValue,`shareStrategy`: RustBufferCollectStrategy,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_matrix_sdk_crypto_ffi_fn_method_olmmachine_decrypt_room_event(`ptr`: Pointer,`event`: RustBuffer.ByValue,`roomId`: RustBuffer.ByValue,`handleVerificationEvents`: Byte,`strictShields`: Byte,`decryptionSettings`: RustBufferDecryptionSettings,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_matrix_sdk_crypto_ffi_fn_method_olmmachine_receive_sync_changes(`ptr`: Pointer,`events`: RustBuffer.ByValue,`deviceChanges`: RustBuffer.ByValue,`keyCounts`: RustBuffer.ByValue,`unusedFallbackKeys`: RustBuffer.ByValue,`nextBatchToken`: RustBuffer.ByValue,`decryptionSettings`: RustBufferDecryptionSettings,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_matrix_sdk_crypto_ffi_fn_method_olmmachine_set_local_trust(`ptr`: Pointer,`userId`: RustBuffer.ByValue,`deviceId`: RustBuffer.ByValue,`trustState`: RustBufferLocalTrust,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    fun uniffi_matrix_sdk_crypto_ffi_fn_method_rehydrateddevice_receive_events(`ptr`: Pointer,`events`: RustBuffer.ByValue,`decryptionSettings`: RustBufferDecryptionSettings,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_matrix_sdk_crypto_ffi_checksum_method_olmmachine_create_encrypted_to_device_request() != 5658.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_matrix_sdk_crypto_ffi_checksum_method_olmmachine_receive_sync_changes() != 57857.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_matrix_sdk_crypto_ffi_checksum_method_olmmachine_verify_device() != 17219.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_matrix_sdk_crypto_ffi_checksum_method_rehydrateddevice_receive_events() != 57511.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class OlmMachine: Disposable, AutoCloseable, OlmMachineInterface {
    ...
    UniffiLib.INSTANCE.uniffi_matrix_sdk_crypto_ffi_fn_method_olmmachine_create_encrypted_to_device_request(
        it, FfiConverterString.lower(`userId`),FfiConverterString.lower(`deviceId`),FfiConverterString.lower(`eventType`),FfiConverterString.lower(`content`),FfiConverterTypeCollectStrategy.lower(`shareStrategy`),_status)
}
    }
    )
    }
    ...
    UniffiLib.INSTANCE.uniffi_matrix_sdk_crypto_ffi_fn_method_olmmachine_receive_sync_changes(
        it, FfiConverterString.lower(`events`),FfiConverterTypeDeviceLists.lower(`deviceChanges`),FfiConverterMapStringInt.lower(`keyCounts`),FfiConverterOptionalSequenceString.lower(`unusedFallbackKeys`),FfiConverterString.lower(`nextBatchToken`),FfiConverterTypeDecryptionSettings.lower(`decryptionSettings`),_status)
}
    }
    )
    }
...
open class RehydratedDevice: Disposable, AutoCloseable, RehydratedDeviceInterface {
    ...
    UniffiLib.INSTANCE.uniffi_matrix_sdk_crypto_ffi_fn_method_rehydrateddevice_receive_events(
        it, FfiConverterString.lower(`events`),FfiConverterTypeDecryptionSettings.lower(`decryptionSettings`),_status)
}
    }
